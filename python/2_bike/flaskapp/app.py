...
@app.route('/')
def home():
    return render_template('flaskapp/templates/index.html')
...
def predict():
    ...
    return render_template('flaskapp/templates/index.html',pred='Total Bike ride counts on {} at {}:00 Hrs will be {}'.format(item[2], item[0],prediction))
