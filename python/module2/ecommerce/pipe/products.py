...
def create_product_output(item):
    ...
    with open("product_urls_" + item + ".txt",'r') as urllist, open('product_output_' + item + '.jsonl','w+') as outfile:
        for url in urllist.read().splitlines():
            ...
            if data:
                try:
                    data['seller_link'] = 'https://www.amazon.de' + data['seller_link']
                    data['freq_bought_link'] = 'https://www.amazon.de' + data['freq_bought_link']
                    data['link_to_all_reviews'] = 'https://www.amazon.de' + data['link_to_all_reviews']
