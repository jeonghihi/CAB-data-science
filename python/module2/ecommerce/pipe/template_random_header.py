...
print('test1', [random_header()], 'test1-useragent', list(random_header().values())[0], 'test1-accept',list(random_header().values())[1])
#dict(zip("user-agent", random_header().values())))
#[x[0] for x in [random_header().values()]],'accept',[x[1] for x in [random_header().values()]])